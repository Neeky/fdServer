"""
Django settings for fdServer project.
...
SECRET_KEY = '2^*bc!dcj3r$$3qp%^lsznywszyfupes2%_na99p*4&lqmsb*!'
...
WSGI_APPLICATION = 'fdServer.wsgi.application'
