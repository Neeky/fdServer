...
class Company(models.Model):
    name=models.CharField(help_text='公司名',max_length=16)
    stockCode=models.CharField(help_text='证券代码',max_length=6,primary_key=True)
    section=models.CharField(help_text='版块 中小企业板|创业板 ...',max_length=8)
    mainPage=models.CharField(help_text='公司在cninfo中的主页地址',max_length=128)

    #以下是公司简介中的内容
    fullName=models.CharField(max_length=16,default='',help_text='公司全称')
    briefName=models.CharField(max_length=16,default='',help_text='公司简称')
    ...
    legalPerson=models.CharField(max_length=16,default='',help_text='法定代表人')
    secretaries=models.CharField(max_length=16,default='',help_text='董秘')
    registeredCapital=models.DecimalField(max_digits=16,decimal_places=4,default=0,help_text='注册资本')
    ...
    companyPhone=models.CharField(max_length=16,default='',help_text='公司电话')
    companyFax=models.CharField(max_length=16,default='',help_text='公司传真')
    companyWebsite=models.CharField(max_length=32,default='',help_text='公司网址')
    ...
    sponsor=models.CharField(max_length=16,default='',help_text='保荐机构')    
