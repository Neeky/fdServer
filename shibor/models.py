...
class ShiborRate(models.Model):
    ...
    def fromJson(self,jdt):
        self.pushDate=jdt['pushDate']
        self.oneNight=jdt['oneNight']
        self.oneWeek=jdt['oneWeek']
        self.twoWeek=jdt['twoWeek']
        self.oneMonth=jdt['oneMonth']
        self.threeMonth=jdt['threeMonth']
        self.sixMonth=jdt['sixMonth']
        self.nineMonth=jdt['nineMonth']
        self.oneYear=jdt['oneYear']
